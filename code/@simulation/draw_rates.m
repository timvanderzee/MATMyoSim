...
if (obj.myosim_options.figure_rates>0)
    ...
    if (startsWith(obj.myosim_muscle.hs(1).kinetic_scheme, ...
        ...
        hold on;
        h(1) = plot(obj.myosim_muscle.hs(1).myofilaments.x, ...
                log10(obj.myosim_muscle.hs(1).rate_structure.r1 * ...
                    ones(numel(obj.myosim_muscle.hs(1).myofilaments.x),1)), 'r-');
        h(2) = plot(obj.myosim_muscle.hs(1).myofilaments.x, ...
