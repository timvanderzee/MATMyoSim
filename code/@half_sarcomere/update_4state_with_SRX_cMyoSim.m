function rate_structure = update_4state_with_SRX_cMyoSim(obj,time_step, m_props, delta_hsl)
...
vf = 1;
r3 = vf * obj.parameters.k_3 * ...
        exp(-0.5 * obj.parameters.k_cb * (obj.myofilaments.x).^2 / ...
            (1e18 * obj.parameters.k_boltzmann * ...
                obj.parameters.temperature));

% length dependence in cMyoSim
yref = 2/3 * 37 - 7.5 - 5.5;
yact = 2/3 * 37/(sqrt(obj.hs_length/1100)) - 7.5 - 5.5;
r3 = r3 * (yref/yact).^2;
            
r3(r3>obj.parameters.max_rate)=obj.parameters.max_rate;  

r4 = obj.parameters.k_4_0 + ...
                (obj.myofilaments.x > 0)  .* (obj.parameters.k_4_1 * ((obj.myofilaments.x + 0 * obj.parameters.x_ps).^4)) + ...
                (obj.myofilaments.x <= 0) .* (obj.parameters.k_4_2 * ((obj.myofilaments.x + 0 * obj.parameters.x_ps).^4));
r4(r4>obj.parameters.max_rate)=obj.parameters.max_rate;

r5 = obj.parameters.k_5_0 + ...
        obj.parameters.k_5_1 * (1 ./ (1 + exp(-obj.myofilaments.x)));
r5(r5 < 0) = 0;
r5(r5 > obj.parameters.max_rate) = obj.parameters.max_rate;

% J6 is a sigmoid in cMyoSim
r6 = obj.parameters.k_6_0 + ...
        obj.parameters.k_6_1 * (1 ./ (1 + exp(-obj.myofilaments.x)));
r6(r6 < 0) = 0;
r6(r6 > obj.parameters.max_rate) = obj.parameters.max_rate;
   
F = obj.parameters.k_cb .* (obj.myofilaments.x + obj.parameters.x_ps);

r7_left = obj.parameters.k_7_0 * exp(-(obj.parameters.k_7_1 * F) ./ (1e18 * obj.parameters.k_boltzmann * ...
                obj.parameters.temperature));

r7 = r7_left  + obj.parameters.max_rate * (1 ./ (1 + exp(-obj.parameters.k_7_3 .* (obj.myofilaments.x - obj.parameters.k_7_2)))); 
